...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/projetos/ATNB/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/projetos/ATNB/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/projetos/ATNB/.claude/commands/gsd
AGENTS_DIR=D:/projetos/ATNB/.claude/agents
```
...
<execution_context>
Surface state file: `D:/projetos/ATNB/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/projetos/ATNB/.claude/skills/.gsd-profile`
Engine module: `D:/projetos/ATNB/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/projetos/ATNB/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
