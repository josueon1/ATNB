...
<!-- For checkpoint task examples and patterns, see @D:/projetos/ATNB/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/projetos/ATNB/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/projetos/ATNB/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/projetos/ATNB/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
