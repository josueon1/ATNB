...
```
Agent(
  prompt="Read D:/projetos/ATNB/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/projetos/ATNB/.claude/get-shit-done/templates/VALIDATION.md`
