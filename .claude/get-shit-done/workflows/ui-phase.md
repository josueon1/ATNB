...
```markdown
Read D:/projetos/ATNB/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/projetos/ATNB/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/projetos/ATNB/.claude/agents/gsd-ui-checker.md for instructions.
