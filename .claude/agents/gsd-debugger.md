...
<required_reading>
@D:/projetos/ATNB/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/projetos/ATNB/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/projetos/ATNB/.claude
                  → checks D:/projetos/ATNB/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/projetos/ATNB/.claude/get-shit-done
                  → writes to D:/projetos/ATNB/.claude/get-shit-done/hooks/
...
@D:/projetos/ATNB/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/projetos/ATNB/.claude/get-shit-done/references/common-bug-patterns.md
