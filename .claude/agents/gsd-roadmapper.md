...
Reference full template: `D:/projetos/ATNB/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/projetos/ATNB/.claude/get-shit-done/templates/state.md`.
